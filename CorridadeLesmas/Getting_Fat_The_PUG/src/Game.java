...
public class Game 
{
    ...
    {
        System.out.println();
        System.out.println("Bem-vindo ao jogo getting fat the PUG!");
        System.out.println("Getting fat the PUG é um jogo de busca, incrivelmente engordativo.");
        System.out.println("O Objetivo deste jogo é procurar muita comida para deixar seu PUG bem gordo.");
        System.out.println("Caminhe pelo parque e encontre comida, caso contrario seu pug irá morrer de FOMEE.");
